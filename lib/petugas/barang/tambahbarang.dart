...
class _TambahProdukState extends State<TambahProduk> {
        ...
        child: SingleChildScrollView(
          child: Form(
            ...
            child: Column(
              ...
              children: [
                _buildTextField('Product Name', 'Product name', _NamaProdukController, Icons.local_florist, const Color.fromARGB(255, 255, 91, 91)),
                _buildTextField('Price', 'Price', _HargaController, Icons.money, const Color.fromARGB(255, 33, 139, 35), isNumber: true),
                _buildTextField('Stock Product', 'Stock Product', _StokController, Icons.storage, Colors.blue, isNumber: true),
                ...
                DropDownTextField(
                  ...
                  textFieldDecoration: InputDecoration(
                    ...
                    prefixIcon: Icon(Icons.category, color: Colors.purple), // Icon for category
                  ),
                  dropDownList: [
  ...
  Widget _buildTextField(String label, String hint, TextEditingController controller, IconData icon, Color iconColor, {bool isNumber = false}) {
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        Text(
